...
(function (root, factory) {
  ...
  function entityKeysOf(req) {
    ...
    if (req.source) { if (req.source.loc) add('locations', req.source.loc); if (req.source.container) add('containers', req.source.container); }
    if (req.target) { if (req.target.loc) add('locations', req.target.loc); if (req.target.container) add('containers', req.target.container); }
