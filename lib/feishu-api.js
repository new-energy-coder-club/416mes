...
const CORS_ALLOW_ORIGIN_RE = [/^https:\/\/([a-z0-9-]+\.)?newenergycoder\.club$/, /^http:\/\/(localhost|127\.0\.0\.1)(:\d+)?$/, /^http:\/\/192\.168\.\d+\.\d+(:\d+)?$/, /^http:\/\/10\.\d+\.\d+\.\d+(:\d+)?$/];
...
module.exports = {
  ...
  fsError, setCors, assertSameOrigin, readBody, resetTokenCache
};
