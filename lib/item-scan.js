...
'use strict';
const sequences={receive:['LOC','CTN','ITM'],issue:['LOC','CTN','ITM'],verifyLegacy:['LOC','CTN','ITM'],transfer:['LOC','CTN','ITM','LOC','CTN'],moveContainer:['CTN','LOC'],placeContainer:['LOC','CTN']};
