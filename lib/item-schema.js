...
const REQUIREMENTS = {
  ...
  itemOperations: {
    '操作ID': [1], '操作类型': [[1, 3], ['receive', 'issue', 'transfer', 'placeContainer', 'moveContainer', 'verifyLegacy', 'retire', 'activateLocation', 'activateContainer', 'registerItem', 'registerLocation', 'registerContainer']],
